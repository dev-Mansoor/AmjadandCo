...
const UpdateProducts = () => {
    ...
    const gettingProductsData = async () => {
        let res = await fetch(`http://localhost:8000/get-updateproducts/${params.id}`)
        res = await res.json();
    ...
    const updateProducts= async(e)=>{
        e.preventDefault();
        let res = await fetch(`http://localhost:8000/updateproducts/${params.id}`,{
            method: 'PUT',
